...
import com.wx3eng.gamideo.Entity.User;
...
public class MySQLConnection {
    ...
    public void setFavoriteItem(String userId, Item item) throws MySQLException {
        ...
        try {
            ...
            e.printStackTrace();
            throw new MySQLException("Failed to save favorite item to DB");
        }
    }

    // Remove a favorite record from the database
    public void removeFavoriteItem(String userId, String itemId) throws MySQLException {
        if (conn == null) {
            System.err.println("DB connection failed");
            throw new MySQLException("Failed to connect to Database");
        }
